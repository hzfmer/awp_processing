# /*******************************************************    ************************
# * Author : Zhifeng Hu | SDSU/UCSD.
# * Email  : hzfmer94@gmail.com
# * Last modified : 2019-08-30 16:51
# * Filename   : my_pyrotd.py
# * Description    : Compute SA/PSA/SV/PSV/SD, based on pyrotd package 
# * *****************************************************    ************************/
...
def shock_response(accels, dt, osc_freq, osc_damping):
    '''Compute shock response of a acceleration tiem series
    Parameters
    ---
    accels: aray_like
